		...
		<?php foreach ($info as $p) : ?>
			...
			<div class="lx-g2">
				<div class="lx-product-details">
					...
					<?php if ($p->discount > 0) { ?>
						<p class="lx-product-price"><span><?php echo $p->price; ?>DH إبتدأ من </span> <?php echo floor($p->price - ($p->price * $p->discount / 100)); ?>DH</p>
					<?php } else { ?>
					...
					<div class="lx-product-qty">
						<ins> إختيار المنتوج : </ins>

						<select class="form-control" name="cat">
							<?php

							foreach ($mantojates as $c) { ?>
