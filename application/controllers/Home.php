...
class Home extends CI_Controller {
	...
	public function show($id = FALSE)
	{
		...
		$m1['السكر'] = 
		 ["قالب السكر","سكر الشاي","سكر قهوة","سكر ساندة","لوسيور"];
		 
		 $m1['الزيوت'] = 
		 ["لوسيور","لوسرا","ويلور","عافية","العود"];
		 
		 $m1['الدقيق'] = 
		 ["فورص عادي","فورص ديال الحلوة","فارينا","سميدة","دقيق بالنخالة"];
		 
		 $m1['الحليب و مشتقاته'] = 
		 ["دانون مسوس","حليب نصف لتر","زبدة لپريري","زبدة بلدية من 3 دراهم","فرماج بكية عادي","فرماج بكية لاڤاش كيري","فرماج كيري","دانون 2 دراهم","دانون 1 دراهم","داناپ","رايبي 2 دراهم","رايبي 3 دراهم","منعيش صغير","عصيري كبير"];
		
		 $m1['الشاي المشروبات الغازية'] = 
		 ["كمانجة","الصينية","البلار","السلطان","4011","الشقور","البارود","إتقان"];

		 $m1['المشروبات الغازية'] = 
		 ["كوكا كولا","هاواي","كوكا زيرو سكر","پومس تفاح"];
		...
		$current_product_title = $data["info"][0]->title;

		$data["mantojates"] = $m1[$current_product_title];
